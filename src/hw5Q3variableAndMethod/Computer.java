...
/*
 * 03) Create a package name "hw5Q3variableAndMethod" in your HW project. Inside the package, 
 * a) Create a class "Computer". Declare some variable -- Brand, Model, Operating system, price, madeInUSA, grade (as char). Implement a method inside the class -- "configuration" and use only one System.out.println(). 
...
public class Computer {
	...
	public void configuration() {
		System.out.println("My Brand: "+Brand+"\nModel: "+Model+"\nOperating System: "+OperatingSystem+"\nPrice: "+price+"$"+"\tMade In USA: "+madeInUSA+"\tGrade: "+grade);
	}
